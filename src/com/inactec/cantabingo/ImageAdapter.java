...
public class ImageAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			Log.e("AAAAAAAAAAAA", "Entra view");
			Log.e("AAAAAAAAAAAA", Integer.toString(position));
	...
	private Integer[] mThumbIds = { R.drawable.c00, R.drawable.c00,
			R.drawable.c00, R.drawable.c00, R.drawable.c00,
			R.drawable.c00, R.drawable.c00, R.drawable.c00,
			R.drawable.c00, R.drawable.c00, R.drawable.c00, R.drawable.c00,
			R.drawable.c00, R.drawable.c00, R.drawable.c00,
			R.drawable.c00, R.drawable.c00, R.drawable.c00,
			R.drawable.c00, R.drawable.c00, R.drawable.c00,
			R.drawable.c00, R.drawable.c00, R.drawable.c00,
